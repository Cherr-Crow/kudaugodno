...
export function FilterPrice({ price, onPriceChange }: IFilterPrice) {
  ...
  const priceData: number[] = [
    1000, 1000, 2000, 2000, 3000, 3000, 5000, 5000, 5000, 6000, 6000, 7000, 8000,
    8000, 9000, 10000, 10000, 12000, 15000, 15000, 18000, 20000, 20000, 20000, 25000,
    25000, 30000, 30000, 30000, 35000, 40000, 40000, 45000, 50000, 50000, 50000,
    55000, 60000, 60000, 60000, 65000, 70000, 75000, 80000, 80000, 85000, 90000,
    95000, 100000, 100000, 110000, 120000, 150000, 150000, 150000, 180000, 200000,
    200000, 250000, 300000, 300000, 350000, 400000, 500000, 500000, 550000, 600000,
    600000, 700000, 750000, 800000, 850000, 900000, 950000, 1000000, 1000000,
  ];
